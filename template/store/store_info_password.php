 ...
 * @version     svn:$Id: store_info_password.php 140016 2009-07-28 06:57:23Z tajima $
 */
...
<div class="sc_subtitle_updt"><?php _e(SCLNG_STORE_USER_HEADER_PASSWORD, SC_DOMAIN); ?></div>
<div class="sc_tbl_updt">
<table>
  <tr>
    <th><?php _e(SCLNG_STORE_USER_PASS, SC_DOMAIN) ?></th>
    <td><?php echo $this->input(array('type'=>'password', 'id'=>'pass1', 'value'=>$user['pass1'], 'class'=>'input_120')); ?><?php $this->error($err_pass1); ?></td>
  </tr>
  <tr>
    <th><?php _e(SCLNG_STORE_USER_PASS_CONFIRM, SC_DOMAIN) ?></th>
